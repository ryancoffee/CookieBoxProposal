...
\subsection*{Angular streaking}\addcontentsline{toc}{subsection}{Angular streaking}
\input{active.streaking.tex}

\subsection*{Attosecond pump-probe}\addcontentsline{toc}{subsection}{Attosecond pump-probe}
\input{active.pumpprobe.tex}

\vspace{10\baselineskip}\\
HERE HERE HERE HERE \\
\vspace{10\baselineskip}\\
Add polarization figure from Lutman paper
\vspace{10\baselineskip}\\
HERE HERE HERE HERE 
\pagebreak
...
\section*{Organization of Major Activities}\addcontentsline{toc}{section}{Organization of Major Activities}
\subsection*{Scope}\addcontentsline{toc}{subsection}{Scope}
\input{active.scope.tex}

\subsection*{Schedule}\addcontentsline{toc}{subsection}{Schedule}
